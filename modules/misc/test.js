...
module.exports.config = {
  ...
  // The first invoker specified in the confid is prepended to the examples
  usage: ['First example description', 'first example', 'Second example description', 'second example'],
